...
//        System.out.println(reverse(-121));
    ...
    public static int reverse(int givenNumber) {
        ...
        boolean isTheNumberNegative = false;
        if (givenNumber < 0) {
            isTheNumberNegative = true;
            givenNumber = givenNumber * -1;
        }
        int lengthOfGivenNumber = getDigitCount(givenNumber);
        do {
            reversedNumber = reversedNumber + ( givenNumber % 10 );
            givenNumber /= 10;
            reversedNumber = reversedNumber * 10;
            lengthOfGivenNumber --;
        } while (lengthOfGivenNumber > 0 );
        reversedNumber /= 10;
        if (isTheNumberNegative) reversedNumber = reversedNumber * -1;
