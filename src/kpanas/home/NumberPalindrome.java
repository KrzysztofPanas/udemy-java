...
public class NumberPalindrome {
    ...
    public static boolean isPalindrome(int number) {
        ...
        int absoluteValueOfGivenNumber;
        if (number < 0) {
            absoluteValueOfGivenNumber = number * -1;
        } else {
            absoluteValueOfGivenNumber = number;
        }
        int copyOfAbsoluteValueOfGivenNumber = absoluteValueOfGivenNumber;
        int lastDigit;
        while(absoluteValueOfGivenNumber > 0){
            lastDigit = absoluteValueOfGivenNumber % 10;
